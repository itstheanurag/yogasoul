...
export const servicesData: Services = [
  {
    ...
    src: `${assetPrefix}/yoga/hatha-yoga.jpg`,
    duration: "60 min",
    price: "$25",
  },
  {
    ...
    src: `${assetPrefix}/yoga/vinyasa-yoga.jpg`,
    duration: "75 min",
    price: "$30",
  },
  {
    ...
    src: `${assetPrefix}/yoga/ashtanga-yoga.jpg`,
    duration: "90 min",
    price: "$35",
  },
  {
    ...
    src: `${assetPrefix}/yoga/power-yoga.jpg`,
    duration: "60 min",
    price: "$28",
  },
  {
    ...
    src: `${assetPrefix}/yoga/corporate-yoga.jpg`,
    duration: "45 min",
    price: "$20",
  },
  {
    ...
    src: `${assetPrefix}/yoga/maternal-yoga.png`,
    duration: "60 min",
    price: "$32",
  },
];
