...
const textAnimationClass =
  "text-xl text-orange-600 font-semibold hover:text-orange-400 transition ease-in delay-150 duration-400 cursor-pointer";

const backgroundAnimationClasses =
  "bg-orange-600 hover:bg-orange-400 transition ease-in delay-150 duration-400";
    ...
    <header className="bg-amber-50 sticky top-0 shadow z-10">
      <div className="flex justify-between items-center px-4 py-3 md:px-8">
        ...
        <ul className="hidden md:flex gap-12">
          <li className={textAnimationClass}>Home</li>
          <li className={textAnimationClass}>Services</li>
