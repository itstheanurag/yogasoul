...
export function TeamCards({ cards }: ExpandableCardDemoProps) {
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-4 py-3 text-sm rounded-full font-bold bg-green-500 hover:bg-green-600 transition text-white"
                  >
                    {active.ctaText}
                  </motion.a>
                </div>
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {cards.map((card) => (
          <motion.div
            ...
            className="p-4 flex flex-col md:flex-row justify-between items-center hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded-xl cursor-pointer transition"
          >
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold bg-gray-100 hover:bg-green-500 hover:text-white text-black mt-4 md:mt-0 transition"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
